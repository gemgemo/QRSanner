...
SWIFT_MODULE_NAMESPACE_PUSH("QRScanner")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC9QRScanner11AppDelegate")
...
SWIFT_CLASS("_TtC9QRScanner7Capture")
...
@interface Capture (SWIFT_EXTENSION(QRScanner)) <AVCaptureMetadataOutputObjectsDelegate>
...
SWIFT_CLASS("_TtC9QRScanner8QRReader")
@interface QRReader : UIViewController
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


@interface QRReader (SWIFT_EXTENSION(QRScanner))
- (void)decodedCodeWithText:(NSString * _Nonnull)text;
@end
